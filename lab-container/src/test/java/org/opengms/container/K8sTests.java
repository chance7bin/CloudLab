...
public class K8sTests {
    ...
    void k8sClientHelloWorld() throws IOException, ApiException {
        ...
        V1PodList list = api.listPodForAllNamespaces(null, null, null, null, null, "true", null, null, null, null);
    ...
    void k8sClientTest(){
        ...
        try {
            V1PodList result = k8sClient.listNamespacedPod(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, timeoutSeconds, watch);
