...
public class DictUtils
{
    ...
    {
        SpringUtils.getBean(RedisCache.class).set(getCacheKey(key), dictDatas);
    }
    ...
    {
        SpringUtils.getBean(RedisCache.class).del(getCacheKey(key));
    }
    ...
    public static void clearDictCache()
    {
        ...
        SpringUtils.getBean(RedisCache.class).del(keys);
    }
